...
<div id="projects" class="loop-projects">
	<?php for($i = 0; $i < 8; $i ++) : ?>
		<div class="project type-project status-publish hentry">
			<div class="wrapper">
				<a href="<?php print esc_url(site_url('index.php?demo_project=1')) ?>" class="image">
					<img width="225" height="200" src="<?php print esc_url(get_template_directory_uri().'/demo/project-loop.jpg') ?>" class="preload wp-post-image" />
				</a>
				
				<div class="overlay"></div>
				
				<a href="<?php print esc_url(site_url('index.php?demo_project=1')) ?>" class="info">
